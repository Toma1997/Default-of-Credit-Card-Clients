...
class Shell(object):
    ...
    HELP = """\nUnesite:
?       - za listu dozvoljenih odgovora na pitanje
rule    - za prikaz tekućeg pravila
why     - za obrazloženje zašto je postavljeno ovo pitanje
help    - za ovao uputstvo
unknown - ako ne znate odgovor na pitanje
<val>   - jedinstveni odgovor na pitanje
